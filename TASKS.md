...
| 037c | Landing: hide/replace "Log ind" for authenticated users  | ⬜     | 037b — bug: sign-in CTA shows to authenticated users. Signed-in → signed-in action (default "Opret indkøbsliste" → /lists); no redirect; reuse Nav session pattern                                                                                                  |
