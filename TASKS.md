...
| 037 | Landing page (root, for everyone)                        | 🟡     | OpenCode (landing content built + verified, but the signed-in-reroute-to-/offers behavior was **reversed 2026-08-14** — Nick re-coding: remove the `<Navigate href="/offers" />`, landing shows for all, Forside → `/` for everyone)                                | 036                        |
