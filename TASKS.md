...
| 037 | Landing page (root; signed-in reroutes to /offers)       | ✅     | OpenCode (browser E2E: signed-out / shows full Danish landing hero + CTAs + what-you-get + how-it-works; signed-in / reroutes to /offers; offers filter+pagination intact; products/stores/404/about back-links -> /offers; about+404 rewritten in Danish). Nav Forside stays / (signed-in users rerouted by the landing) — SolidStart 2.0 session read outside Suspense doesn't update reactively, noted in Nav.tsx | 036                        |
