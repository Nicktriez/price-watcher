...
| 038i | Reward message: "Community" → "Fællesskab" (tier consistency) | 🔄     | **Found 2026-08-15** (Ultron, batch-deploy verify): 038f unified tier label to Fællesskab on client pages, but server-side reward msg `src/server/report.ts:156` still returns "Tak! Din pris hjalp gruppen til Community…". One user-facing string. Spec: `tasks/038i-community-tier-msg.md`. **NOT yet implemented.**                                                                                                                                                                                                       | 038f (tier consistency)                   |
