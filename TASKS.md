...
| 038l | Fix multi-product split over-splitting (hyphen-continuation)  | 🔄     | **Found 2026-08-15** (Ultron, reviewing 038j live): `splitOfferHeading` wrongly splits Danish hyphen-continuation — "Softkerne- eller græskarkernerugbrød" is ONE bread, not an either/or deal. Live backfill created phantom products (4 "Softkerne" + 1 "græskarkernerugbrød"). The 038j test even asserts the wrong behavior. Fix: don't split when the pre-"eller" token ends in `-` and continues a compound modifier; repair the phantom products. Spec: `tasks/038l-fix-over-split.md`. **NOT yet implemented.**                                                   | 038j (split)                              |
