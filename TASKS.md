...
| 038c | Mobile-friendly navbar (hamburger on mobile)       | 🔄     | Spec written (2026-08-15): Nav.tsx keeps desktop row unchanged at `md:`+; below `md:` a hamburger toggle expands a vertical link panel; aria-expanded + 44px tap targets; outside-click/Esc closes; menu resets on route change; auth preserved. Spec: `tasks/038c-mobile-navbar.md`. **NOT yet implemented.**                                                                                                                                                                                                                | 036 (nav built); beta usability     |
