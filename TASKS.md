...
| 038e | Danish consistency: compare + product pages (English leakage) | 🔄     | **Found 2026-08-15** (Nick, live on beta.skujeg.dk): `/compare/[id]` leaks ~13 English strings (table headers Store/Basket/Fuel/Total, empty states, "Your basket is cheapest at…", "Set your home address", fuel heading); `/products/[id]` leaks ~11 (trust badge Official offer/Community/User-reported, "Current offers", "Unknown chain/store", "Price history"). Fix: translate to plain Danish, keep trust-tier labels consistent app-wide. Spec: `tasks/038e-danish-compare-product.md`. **NOT yet implemented.**     | 037d (report-page Danish); beta usability |
