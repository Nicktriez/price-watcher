...
| 038e | Danish consistency: compare + product pages (English leakage) | ✅     | OpenCode (browser E2E: compare headers Butik/Kurv/Brændstof (tur-retur)/I alt inkl. brændstof + tier header + Brændstofpriser (landsgennemsnit); product page Aktuelle tilbud/Brugerrapporterede priser/Priser fra fællesskabet + Officielt tilbud badge; reported-items too). **Ultron caveat 2026-08-15: product page STILL leaks 3 strings (trust badge "Community" line 49, "No crowd shelf prices…" line 153, "No price history yet" line 197) + "Community" in 2 files (products:49, reported-items:15) — inconsistent tier label. NOT deployed pending 038f.** | 037d (report-page Danish); beta usability |
| 038f | Danish: product page leftovers + tier-label consistency       | 🔄     | **Follow-up to 038e** (Ultron verified 2026-08-15): product page still has 3 English strings (trust badge "Community" line 49, "No crowd shelf prices…" line 153, "No price history yet" line 197). Also `"Community"` appears in 2 files (products:49, reported-items:15) — must unify to one Danish tier label across all 5 tier-rendering files (products, reported-items, compare, report, about). Spec: `tasks/038f-danish-product-page-leftovers.md`. **NOT yet implemented.**                                                                                  | 038e (partial)                            |
