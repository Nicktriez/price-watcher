...
| 037d | Report page: fix English leakage (Danish)                | ⬜     | — pre-beta fix: /report leaks English (H1 "Report a shelf price", placeholders "Search by store...", "e.g. 12.95"). Translate all copy to Danish.                                                                                                                   |
