# Task 042 — Screenshot-Worthy Store Comparison + Madplan
...
Polish the **store comparison** (Phase 4 Task 022) and the **madplan** (Phase 4 Task 023) to be **screenshot-worthy** — clean, shareable, and aligned with the winning design system (Task 040). These are the "screenshot-for-distribution" moments and the single most shareable asset (feeds the "madplan for 500 kr" blog content engine).
...
3. Both aligned to the **design-system tokens** (Task 040) — not a separate style.
