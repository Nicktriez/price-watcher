# Task 043 — Mobile Check: Receipt Upload Flow
...
3. **Verify the design-system restyle (Task 040) didn't regress mobile** — the upload + receipt screens must be usable in the new design.
